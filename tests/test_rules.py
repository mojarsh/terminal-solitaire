...
from terminal_solitaire.rules import alternating_colour_rule, lower_value_rule, higher_value_foundation_rule, king_to_empty_space_rule, same_suit_foundation_rule
...
def test_higher_value_foundation_rule_happy_path() -> None:
    assert higher_value_foundation_rule(Card(Suits.HEARTS, Values.TWO, "Red"), jack_of_hearts) is False
